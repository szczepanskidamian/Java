...
public class Program
{
   ...
   {                                          
	...
	System.out.println("okrag: " + obj3 +"\nprogram.Okrag zawiera punkt (x: 3, y: 2)? " + obj3.zawiera(new Punkt (3,2)) + "\n" +
			"program.Okrag zawiera punkt (x: 3, y: 2)? " + obj3.zawiera(new Punkt (-3,2)) + "\n");
	Punkt pkt = new Punkt(2,3);
	Punkt pkt2 = new Punkt(7,-1);
	System.out.println(obj2.toString());
	System.out.println("program.Prostokat zawiera punkt " + pkt.toString() + "? " + obj2.zawiera(pkt) +
			"\nprogram.Prostokat zawiera punkt " + pkt2.toString() + "? " + obj2.zawiera(pkt2) + "\n");
